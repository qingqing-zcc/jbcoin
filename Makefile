#############################################################################
# Makefile for building: jbcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Dec 22 13:49:50 2013
# Project:  jbcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -o Makefile jbcoin-qt.pro
#############################################################################
...
Makefile: jbcoin-qt.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile jbcoin-qt.pro

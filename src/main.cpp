...
const string strMessageMagic = "JbCoin Signed Message:\n";
...
// jbcoin: increasing Nfactor gradually
...
int64 GetProofOfWorkReward(unsigned int nBits)
{
    ...
    // JbCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JbCoin
    bool fStrictPayToScriptHash = true; // Always active in JbCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JbCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
